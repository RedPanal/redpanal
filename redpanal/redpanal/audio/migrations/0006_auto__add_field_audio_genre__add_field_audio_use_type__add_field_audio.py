...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Audio.genre'
        db.add_column(u'audio_audio', 'genre',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=30),
                      keep_default=False)

        # Adding field 'Audio.use_type'
        db.add_column(u'audio_audio', 'use_type',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=30),
                      keep_default=False)

        # Adding field 'Audio.instrument'
        db.add_column(u'audio_audio', 'instrument',
                      self.gf('django.db.models.fields.CharField')(default='other', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Audio.genre'
        db.delete_column(u'audio_audio', 'genre')

        # Deleting field 'Audio.use_type'
        db.delete_column(u'audio_audio', 'use_type')

        # Deleting field 'Audio.instrument'
        db.delete_column(u'audio_audio', 'instrument')
