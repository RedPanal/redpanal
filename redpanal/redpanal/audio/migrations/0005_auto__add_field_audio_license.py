...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'audio_audio', 'license',
                      self.gf('django.db.models.fields.CharField')(default='CC-BY-SA-4.0', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Audio.license'
        db.delete_column(u'audio_audio', 'license')
