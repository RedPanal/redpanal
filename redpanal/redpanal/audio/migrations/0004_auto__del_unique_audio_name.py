...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Audio', fields ['name']
        db.delete_unique(u'audio_audio', ['name'])


    def backwards(self, orm):
        # Adding unique constraint on 'Audio', fields ['name']
        db.create_unique(u'audio_audio', ['name'])
