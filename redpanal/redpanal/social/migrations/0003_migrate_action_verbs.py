    ...
    def forwards(self, orm):
        ...
        for action in orm["actstream.Action"].objects.all():
            ...
            if action.verb not in ["commented", "audio_created", "project_created"]:
                action.delete()
            if action.verb == "audio_created":
                if action.action_object_content_type:
                    action.target_content_type = action.action_object_content_type
                    action.target_content_type_id = action.action_object_content_type_id
                    action.target_object_id = action.action_object_object_id
                    action.save()
                    action.action_object_content_type = None
                    action.action_object_content_type_id = None
                    action.action_object_object_id = None
                    action.save()
