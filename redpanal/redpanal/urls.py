...
urlpatterns = patterns('',
    ...
    url(r'^tag/(?P<slug>[\w-]+)/audios/$', 'redpanal.core.views.hashtaged_list_audios', name="hashtaged-list-audios"),
    url(r'^tag/(?P<slug>[\w-]+)/projects/$', 'redpanal.core.views.hashtaged_list_projects', name="hashtaged-list-projects"),
    url(r'^tag/(?P<slug>[\w-]+)/messages/$', 'redpanal.core.views.hashtaged_list_messages', name="hashtaged-list-messages"),
