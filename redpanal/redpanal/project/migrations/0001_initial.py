...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'project_project', (
            ...
            ('version_of', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project.Project'], null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'project', ['Project'])

        # Adding M2M table for field audios on 'Project'
        m2m_table_name = db.shorten_name(u'project_project_audios')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'project_project_audios'))
