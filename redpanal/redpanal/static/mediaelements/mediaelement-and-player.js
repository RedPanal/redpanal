...
(function ($) {
	...
	mejs.MepDefaults = {
		...
		audioHeight: -1,
		// height of audio image wave player
		audioWaveHeight: -1,
		// extension
		customSize: '',
...
(function($) {
	...
	$.extend(MediaElementPlayer.prototype, {
		buildprogress: function(player, controls, layers, media) {
            console.log(media);
			$('<div class="mejs-time-rail '+player.options.customSize+'">'+
				'<span class="mejs-time-total">'+
					'<span class="mejs-time-buffering '+player.options.customSize+'"></span>'+
					'<span class="mejs-time-loaded '+player.options.customSize+'"></span>'+
					'<span class="mejs-time-current '+player.options.customSize+'"></span>'+
					'<span class="mejs-time-handle '+player.options.customSize+'"></span>'+
